...
const int POneing = 10;            // Dorr oneing pulsation
const int PClosing = 11;            // door closing pulsation
...
void setup() {
 ...
 pinMode(POneing, OUTPUT);
  pinMode(PClosing, OUTPUT);
  ...
  digitalWrite(POneing, 1);
  digitalWrite(PClosing, 1);
...
displayText("30 s ");
    digitalWrite(POneing, 0);
    delay(3000);

    digitalWrite(POneing, 1);
testProte();

    digitalWrite(PClosing, 0);
     delay(3000);
